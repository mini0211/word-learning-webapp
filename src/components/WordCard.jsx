export default function WordCard({ word, flipped, onFlip }) {
  ...
  return (
    <button type="button" onClick={onFlip} className="card-3d group h-[30rem] w-full text-left outline-none focus-visible:ring-4 focus-visible:ring-indigo-200" aria-label={flipped ? '단어 카드 앞면 보기' : '단어 카드 뜻 보기'}>
